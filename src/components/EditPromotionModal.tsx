...
import styles from './CreatePromotionModal.module.scss'; // Reusing the same styles
...
const EditPromotionModal: React.FC<EditPromotionModalProps> = ({
  ...
  // Pre-populate form when promotion changes
  useEffect(() => {
    if (promotion) {
      setFormData({
        name: promotion.name,
    ...
    <div className={styles.modalOverlay} onClick={handleClose} onKeyDown={handleKeyDown}>
      <div className={styles.modalContent} onClick={(e) => e.stopPropagation()}>
        ...
        <div className={styles.modalHeader}>
          <h2 className={styles.modalTitle}>Editar Promoción</h2>
